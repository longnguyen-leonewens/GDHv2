...
/**
  ...
  */
FlashSim_State_t FlashSim_Read(uint64_t startAddress, uint8_t* const buff, uint32_t size)
{
    FlashSim_State_t retVal = FLASH_SIM_STATE_OK;
...
/**
  ...
  * @retval FlashSim_State_t
  */
FlashSim_State_t FlashSim_Write(uint64_t startAddress, uint8_t* const buff, uint32_t size)
{
    FlashSim_State_t retVal = FLASH_SIM_STATE_OK;
    uint8_t* p_data = (uint8_t*)(startAddress + &s_FlashMem[0][0]);
...
/**
  ...
  * @retval FlashSim_State_t
  */
FlashSim_State_t FlashSim_EraseMultiSector(uint64_t sectorIndex, uint32_t numOfSector)
{
